...
void TriMesh::storeFacesPoints() {
    ...
    for (int i = 0; i < 12; i++)
    {
        points.push_back(glm::vec3(vertex_positions[faces[i].x]));
        colors.push_back(vertex_colors[i%5]);
        points.push_back(glm::vec3(vertex_positions[faces[i].y]));
        colors.push_back(vertex_colors[i%5]);
        points.push_back(glm::vec3(vertex_positions[faces[i].z]));
        colors.push_back(vertex_colors[i%5]);
    }
